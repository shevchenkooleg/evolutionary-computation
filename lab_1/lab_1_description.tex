...
\begin{enumerate}
    ...
    0.05 & 130 & $5.998\times10^{-8}$ & $4.374\times10^{-4}$ & $\checkmark$ \\ \hline
    0.1 & 66 & $2.172\times10^{-8}$ & $2.843\times10^{-4}$ & $\checkmark$ \\ \hline
    0.4 & 16 & $2.294\times10^{-9}$ & $2.862\times10^{-4}$ & $\checkmark$ \\ \hline
    0.52 & 92 & $2.784\times10^{-8}$ & $5.093\times10^{-4}$ & $\checkmark$ \\ \hline
    0.6 & 1000 & $3.277\times10^{139}$ & $1.315\times10^{70}$ & $\times$ \\ \hline
    \end{tabular}
    ...
    \begin{enumerate}
        \item Построен график сходимости функции $f(x_k)$ при разных значениях $\alpha$ (Рисунок \ref{fig:convergence_alpha})
        \item Построены траектории спуска на линиях уровня функции (Рисунок \ref{fig:trajectories_alpha})
        \item Построен график влияния числа обусловленности $k$ на сходимость (Рисунок \ref{fig:kappa_convergence})
    \end{enumerate}
\end{enumerate}
